...
int ell(double *A, int n, int m){
    ...
    alpha = norm1est_(abs_A, n, 2*m + 1) /norm_A;
...
void pq_m_13(double *A, double *A2, double *A4, double *A6, int n, int m, double *P_m, double *Q_m){
    ...
    // matrix_multiply_blas_(n, n, n, U1, A6, &U1);
    // matrix_multiply_blas_(n, n, n, V1, A6, &V1);
    // FLOPS_ADD_N3(4)
...
int mexp_no_blas(double* A, double *A2, double *A4, double *A6, double *A8, double *A10, double **X, int n){
    ...
    // matrix_multiply_blas_(n, n, n, A, A, &A2);
    // FLOPS_ADD_N3(2)
    ...
    if (eta1 <= theta[3] && ell(A, n, 3) == 0) {
        ...
        pq_m_3579(A, A2, A4, A6, A8, n, 3, p3, q3);
    ...
    // matrix_multiply_blas_(n, n, n, A2, A2, &A4);
    // FLOPS_ADD_N3(2)
    ...
    if (etA2 <= theta[5] && ell(A, n, 5) == 0){
        ...
        pq_m_3579(A, A2, A4, A6, A8, n, 5, p5, q5);
    ...
    // matrix_multiply_blas_(n, n, n, A2, A4, &A6);
    // matrix_multiply_blas_(n, n, n, A2, A6, &A8);
    // FLOPS_ADD_N3(4)
    ...
    for (int m = 7; m < 10; m+=2) {
        if (eta3 <= theta[m] && ell(A, n, m) == 0){
            ...
            pq_m_3579(A, A2, A4, A6, A8, n, m, p_m, q_m);
   ...
   // Continues below
    ...
    // matrix_multiply_blas_(n, n, n, A4, A6, &A_temp);
    // FLOPS_ADD_N3(2)
    double eta4 = fmax(d8, pow(norm1est_(A10, n, 1), 1.0 / 10.0));
    ...
    pq_m_13(A_copy, A2, A4, A6, n, 13, p13, q13);
